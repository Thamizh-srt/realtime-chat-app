...
export default function MessageBubble({ message, isOwnMessage, showAvatar = true }) {
  const senderName = message.user?.name || message.sender || 'Unknown';
    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="mt-1 text-[10px] text-muted-foreground opacity-0 transition-opacity duration-200 group-hover:opacity-100 px-1">
